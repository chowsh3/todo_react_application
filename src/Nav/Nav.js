    ...
    return (
        <div className="Nav">
            <nav className="navbar sticky-top navbar-expand-md navbar-light bg-white">
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li className="nav-item active">
                            <a className="nav-link" href="#"><button type="button" className="btn btn-light"><svg
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#"><button type="button" className="btn btn-light"><svg className="bi bi-list-ul"
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#"><button type="button" className="btn btn-light"><svg id="Capa_1"
                                enable-background="new 0 0 512 512" height="1em" viewBox="0 0 512 512" width="1em"
                                xmlns="http://www.w3.org/2000/svg">
                                <g id="_x3C_Group_x3E__28_">
                                    <path
                                        d="m376 60v60h-240v-60h-75v452h390v-452zm-225 397.21-40.61-40.6 21.22-21.22 19.39 19.4 49.39-49.4 21.22 21.22zm0-90-40.61-40.6 21.22-21.22 19.39 19.4 49.39-49.4 21.22 21.22zm0-90-40.61-40.6 21.22-21.22 19.39 19.4 49.39-49.4 21.22 21.22zm240 143.79h-150v-30h150zm0-90h-150v-30h150zm0-90h-150v-30h150z" />
                                    <path
                                        d="m286 30c0-16.569-13.43-30-30-30-16.569 0-30 13.43-30 30-7.259 0-52.693 0-60 0v60h180c0-7.259 0-52.693 0-60-7.259 0-52.693 0-60 0z" />
                                </g>
                            </svg></button></a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#"><button type="button" className="btn btn-light"><svg className="bi bi-plus-circle-fill" width="2em" height="2em"
                ...
                <div className="side">
                    <button type="button" className="btn btn-white"><svg className="bi bi-check" width="1em" height="1em"
                        viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                    ...
                    <button type="button" className="btn btn-white"><svg className="bi bi-bell" width="1em" height="1em"
                        viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button type="button" className="btn btn-white"><svg className="bi bi-archive" width="1em" height="1em"
                        viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
