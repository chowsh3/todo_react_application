        ...
        <div className="New-tasks">
            <div className="input-group mb-3 col">
                ...
                <div className="input-group-append">
                    <button className="btn btn-warning" type="button" id="button-addon2"><svg className="bi bi-bell" width="1em"
                    ...
                    <button className="btn btn-secondary" type="button" id="button-addon2"><svg className="bi bi-pencil"
                    ...
                    <button className="btn btn-danger" type="button" id="button-addon2"><svg className="bi bi-trash" width="1em"
                        height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
